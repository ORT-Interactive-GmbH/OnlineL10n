...
class UILanguageProvider: LanguageProvider {
    ...
    @objc func languageKeys(language: String) -> [String : String] {
        if language == "Deutschland" {
            ...
            return ["top_label" : "Top label text in English", "button" : "A button", "text_field" : "a beautiful text field", "text_view" : "a multi-line text view which is\nnot\nentirely\nfilled.", "segment_0" : "German", "segment_1" : "English", "placeholder" : "placeholdertext", "de.ortinteractive.OnlineL10n.countrycontroller.title" : "Select country", "de.ortinteractive.OnlineL10n.countrycontroller.back" : "", "de.ortinteractive.OnlineL10n.countrycontroller.done" : "Done"]
        }
    }
